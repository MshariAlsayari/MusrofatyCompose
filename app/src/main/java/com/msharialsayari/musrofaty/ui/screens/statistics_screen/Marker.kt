...
internal fun rememberMarker(): Marker {
    val secondaryColor = MusrofatyTheme.colors.secondary
    val labelBackground = remember(secondaryColor) {
        ShapeComponent(labelBackgroundShape, color = secondaryColor.toArgb()).setShadow(
    ...
    val indicatorInnerComponent = shapeComponent(Shapes.pillShape, MusrofatyTheme.colors.onSecondary)
    ...
    val guideline = lineComponent(
        secondaryColor.copy(GUIDELINE_ALPHA),
        guidelineThickness,
        guidelineShape,
    )
