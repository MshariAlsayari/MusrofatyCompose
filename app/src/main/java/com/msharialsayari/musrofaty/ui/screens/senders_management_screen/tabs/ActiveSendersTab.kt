...
fun ActiveSendersTab(viewModel:SendersManagementViewModel,onNavigateToSenderDetails:(senderId:Int)->Unit){
    ...
    SendersListCompose(viewModel = viewModel, list = SendersListViewModel.SendersUiState.wrapSendersToSenderComponentModelList(list), onNavigateToSenderDetails = onNavigateToSenderDetails,isActiveTab = true)
